...
def product_custom_id(product_name):
    hashed = hashlib.sha256(
        product_name.encode("utf-8")
    ).hexdigest()[:16]

    return f"kira_buy_{hashed}"
